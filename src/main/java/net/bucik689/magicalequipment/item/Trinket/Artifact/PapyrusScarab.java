...
public class PapyrusScarab extends SummonerTrinketBase {
    public PapyrusScarab(String itemName, Rarrity rarrity, SlotType slotType) {
        super(itemName, rarrity, slotType, 1, 0);
    }
}
