...
public class ModItems {
        ...
        public static final TrinketBase RING_OF_RESISTANCE = new RingEffect("ring_of_resistance", StatusEffects.RESISTANCE, 0);
        public static final TrinketBase ADVANCED_RING_OF_RESISTANCE = new RingEffect("advanced_ring_of_resistance", StatusEffects.RESISTANCE, 1);
        ...
        public static final TrinketBase RING_OF_STRENGTH = new RingEffect("ring_of_strength", StatusEffects.STRENGTH, 0);
        public static final TrinketBase ADVANCED_RING_OF_STRENGTH = new RingEffect("advanced_ring_of_strength", StatusEffects.STRENGTH, 1);
