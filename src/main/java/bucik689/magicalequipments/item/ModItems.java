...
public class ModItems {
        ...
        public static final Trinket ADHESIVE_BANDAGE = new Trinket(new Item.Settings().group(ItemGroup.MISC), "adhesive_bandage", new EffectDefiniction[] {});
        public static final Trinket ARMOR_POLISH = new Trinket(new Item.Settings().group(ItemGroup.MISC), "armor_polish", new EffectDefiniction[] {});
        public static final Trinket COBALT_SHIELD = new Trinket(new Item.Settings().group(ItemGroup.MISC), "cobalt_shield", new EffectDefiniction[] {});
